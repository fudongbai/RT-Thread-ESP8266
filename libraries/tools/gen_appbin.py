...
def gen_appbin():
    ...
    os.system("rm -rf eagle.app.v6.text.bin eagle.app.v6.data.bin eagle.app.v6.rodata.bin eagle.app.v6.irom0text.bin")
    os.system("rm -rf rtthread.elf")
